...
flowchart TD
    ...
    Y -- "是" --> Z[".pmo_runtime/history/reference/legacy-transition-notes.md<br/>只做轻量 reminder check"]
...
- `.pmo_runtime/history/reference/legacy-transition-notes.md` 是 reminder surface，不是常规阻塞流程。
