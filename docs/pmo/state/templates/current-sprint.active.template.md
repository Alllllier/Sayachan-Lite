# Current Sprint Active Template

- Sprint: `<selected sprint or micro-fix name>`
- Status: `active`
- Phase: `selected | handed-off | executing | reported | closing`
- PMO owner: `Codex`
...
- Selection date:
- Candidate source:
- Related discussion, backlog, or decision entries:
