...
| `discussion_batch_011` | `follow-up` | `Frontend style baseline refactor` | `Keep the landed structure/baseline pass, controls-core first pass, action-grouping baseline, and secondary-controls/reveal baseline as context while later legacy cleanup plus input-state follow-ons remain open.` | `active` | `2026-04-22` | `slice-001 completed; slice-003 first pass completed; action-grouping follow-on completed; slice-004 completed` |
