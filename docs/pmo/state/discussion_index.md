...
| `discussion_batch_011` | `follow-up` | `Frontend style baseline refactor` | `Keep the landed first-pass structure/baseline slice as context while interactive controls and later legacy follow-ons remain the next live discussion directions.` | `active` | `2026-04-21` | `slice-001 completed; controls and later cleanup remain pending` |
