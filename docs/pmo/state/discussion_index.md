...
| `discussion_batch_012` | `follow-up` | `Frontend display-list baseline and list grammar` | `Keep the completed Projects task-preview validation slice as proven context while the broader Dashboard and AI/list convergence follow-ons remain open.` | `active` | `2026-04-23` | `slice-001 completed after candidate execution; later Dashboard and AI/list follow-ons remain in discussion` |
