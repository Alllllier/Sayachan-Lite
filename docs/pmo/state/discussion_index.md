...
| `discussion_batch_017` | `follow-up` | `Owner-led auth and invite-gated tester accounts` | `Keep the settled owner/tester, invite-gated registration, lightweight owner capability, and account-isolation direction as source context for the promoted auth candidates.` | `promoted` | `2026-05-04` | `promoted to decision_log plus two sprint_candidates` |
