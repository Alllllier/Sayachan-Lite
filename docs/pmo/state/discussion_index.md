...
| `discussion_batch_018` | `follow-up` | `Engineering modernization path after MVP guardrails` | `Use the backend TS/ESM migration lessons to shape the next frontend TypeScript step without jumping to full-repo checkJs, Vue SFC conversion, or unclassified scaffolding deletion.` | `active` | `2026-05-07` | `backend TS/ESM route/service/model/middleware migration completed; frontend TS remains open after task-service and apiClient pilots; likely next move is Frontend TypeScript Support Boundary Plan` |
