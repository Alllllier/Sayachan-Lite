...
| `discussion_batch_016` | `follow-up` | `Backend minimal layering and validation architecture` | `Shape the backend service/validation/error/config/app-composition line from the archived backend architecture audit into near-term bounded slices.` | `active` | `2026-05-04` | `undecided; likely first candidate is CRUD service extraction` |
