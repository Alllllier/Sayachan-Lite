...
| `discussion_batch_012` | `follow-up` | `Frontend display-list baseline and list grammar` | `Keep the completed Projects and Dashboard anchor slices as proven context while the later AI/list convergence follow-on remains open.` | `active` | `2026-04-24` | `slice-001 completed; pass-2 Dashboard saved tasks completed; later AI/list convergence remains in discussion` |
