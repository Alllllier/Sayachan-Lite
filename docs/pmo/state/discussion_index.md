...
| `discussion_batch_010` | `follow-up` | `Frontend display semantics and test coverage buildout` | `Clarify project-surface archive display semantics first, then shape a frontend testing path that starts with panel behavior rather than prematurely locking unstable surfaces.` | `active` | `2026-04-20` | `undecided` |
