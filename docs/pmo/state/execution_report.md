...
- local execution:
  - not run during this loop
  - reason: this sprint kept the cleanup entry available but did not assume a desired mutation of the current development database during implementation validation
