...
- public bridge: `backend/src/privateCore/bridge.ts`
...
- public chat route: `backend/src/routes/aiRoutes.ts`
...
Treat `backend/src/privateCore/bridge.ts` as the only intended public bridge into the private core.
