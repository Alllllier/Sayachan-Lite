...
- **Dashboard** - 快速新增任务、Saved Tasks 管理、Chat cockpit context
...
2. **Task** - 从 Notes 或 Projects AI 建议生成可执行任务，也可以从 Dashboard 快速新增
...
- [x] AI 辅助（Notes task drafts、Projects Next Action、Chat）
